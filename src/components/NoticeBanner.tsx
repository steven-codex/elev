      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex-1 flex items-center justify-center gap-2.5 flex-wrap text-center">
          <div className="flex items-center gap-1.5 font-normal">
            ...
            <span className="text-[#0A0D14] font-normal">
              Introducing elev <span className="tabular-nums font-normal">2.4</span> — built to handle all of the work around meetings.
            </span>
          </div>
          ...
          <button
            onClick={onOpenDemo}
            className="inline-flex items-center gap-1 text-[11px] font-normal px-2.5 py-0.5 rounded-full bg-white hover:bg-slate-50 text-[#0A0D14] border border-[#BFDBFE] shadow-2xs active:scale-[0.96] transition-[background-color,transform,border-color] duration-150 cursor-pointer group"
          >
