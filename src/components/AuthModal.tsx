        ...
        {success ? (
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="font-extrabold text-xl text-slate-900">elev</span>
            </div>
            ...
            <div className="space-y-2.5 mb-5">
              <button
                ...
                className="w-full py-2.5 px-4 rounded-xl border border-slate-300 hover:bg-slate-50 font-bold text-xs text-slate-700 flex items-center justify-center gap-2.5 transition-colors cursor-pointer"
              >
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-[10px] uppercase">
                <span className="bg-white px-2 text-slate-400 font-bold tracking-wider">or with work email</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs px-3.5 py-2.5 rounded-xl border border-slate-300 focus:outline-hidden focus:ring-2 focus:ring-blue-600 bg-white"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full mt-2 bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-white font-bold text-xs py-3 rounded-full transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-md"
              >
