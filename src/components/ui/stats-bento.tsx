      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 sm:mb-16 gap-6">
          <div className="max-w-2xl">
            ...
            <h2 className="text-3xl sm:text-5xl lg:text-6xl font-normal text-[#0A0D14] tracking-tight leading-[1.08] text-balance">
              Proven at <span className="font-instrument italic font-normal bg-gradient-to-r from-[#418AC1] to-[#506DFD] bg-clip-text text-transparent inline-block pr-1">enterprise scale</span>
            </h2>
            ...
            {(
              ...
              return (
                <button
                  ...
                  className={`px-3.5 py-1.5 rounded-xl text-xs font-normal transition-[background-color,color,box-shadow] duration-200 cursor-pointer active:scale-[0.96] ${
                    isActive
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 md:grid-rows-2 gap-4 max-w-7xl mx-auto items-stretch">
          ...
          <div className="md:col-span-3 md:row-span-2 bg-[#0B1222] text-white rounded-3xl p-8 sm:p-10 flex flex-col justify-between overflow-hidden relative group border border-slate-800/80 shadow-lg min-h-[380px] sm:min-h-[440px]">
            ...
            <div className="relative z-10">
              <span className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 backdrop-blur-md rounded-full text-[10px] font-normal text-blue-200 uppercase tracking-widest mb-6 border border-white/10 shadow-2xs">
              ...
              <div className="flex items-baseline gap-3">
                ...
                <span className="text-xs sm:text-sm font-sans tabular-nums text-slate-400 font-normal">
            ...
            <div className="relative z-10 pt-8 mt-auto">
              ...
              <div className="mt-8 pt-6 border-t border-slate-800/80 flex items-center justify-between">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#418AC1] to-[#506DFD] hover:brightness-105 text-white text-xs font-normal shadow-xs hover:shadow-md hover:shadow-blue-500/20 active:scale-[0.96] transition-[transform,box-shadow,filter] duration-150 cursor-pointer group/btn"
                >
          ...
          <div className="md:col-span-3 bg-white rounded-3xl p-7 sm:p-8 border border-[#E2E8F0] shadow-2xs flex flex-col sm:flex-row sm:items-center justify-between gap-6 relative overflow-hidden group hover:border-blue-200 transition-[border-color,box-shadow] duration-200">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <p className="text-xs font-normal uppercase tracking-widest text-slate-500 font-sans">
          ...
          <div className="md:col-span-1 bg-white rounded-3xl p-6 border border-[#E2E8F0] shadow-2xs flex flex-col justify-center text-center items-center group hover:border-stone-300 transition-[border-color,box-shadow] duration-200 relative overflow-hidden">
            ...
            <p className="text-[11px] font-normal uppercase tracking-wider text-slate-500 font-sans mt-0.5">
              {current.kpi.label}
            </p>
            <span className="text-[10px] text-emerald-600 font-normal mt-1.5 bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-200/60">
          ...
          <div className="md:col-span-2 bg-white rounded-3xl p-6 border border-[#E2E8F0] shadow-2xs flex items-center gap-4 group hover:border-stone-300 transition-[border-color,box-shadow] duration-200 relative overflow-hidden">
            ...
            <div className="w-12 h-12 text-2xl rounded-full bg-amber-50 text-amber-500 border border-amber-200/70 flex items-center justify-center shrink-0 shadow-2xs font-normal group-hover:scale-105 transition-transform duration-200">
              <span className="leading-none select-none">★</span>
            </div>

            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                <p className="text-base sm:text-lg font-normal text-[#0A0D14] leading-none tabular-nums font-sans">
                  {current.rating.score}
                </p>
                <div className="inline-flex items-center gap-1 text-[10px] text-emerald-700 bg-emerald-50 px-1.5 py-0.5 rounded-md border border-emerald-200/60 font-normal">
                  <CheckCircle2 className="w-3 h-3 text-emerald-600" />
                  <span>Verified</span>
                </div>
              </div>

              <p className="text-xs font-normal text-slate-600 mt-1 truncate">
